...
namespace tipoDiplom.Forms
{
    partial class EmployeeChange
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EmployeeChange));
            button1 = new Button();
            button2 = new Button();
            label2 = new Label();
            label3 = new Label();
            ...
            button2.TabIndex = 1;
            button2.Text = "Изменить тользователя";
